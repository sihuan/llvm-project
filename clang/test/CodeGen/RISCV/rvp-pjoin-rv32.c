...
// RV32-LABEL: @test_pjoin4_i8x4(
// RV32-NEXT:  entry:
// RV32-NEXT:    [[TMP0:%.*]] = insertelement <4 x i8> poison, i8 [[E0:%.*]], i64 0
// RV32-NEXT:    [[TMP1:%.*]] = insertelement <4 x i8> [[TMP0]], i8 [[E1:%.*]], i64 1
// RV32-NEXT:    [[TMP2:%.*]] = insertelement <4 x i8> [[TMP1]], i8 [[E2:%.*]], i64 2
// RV32-NEXT:    [[TMP3:%.*]] = insertelement <4 x i8> [[TMP2]], i8 [[E3:%.*]], i64 3
...
// RV32-LABEL: @test_pjoin2_i16x2(
// RV32-NEXT:  entry:
// RV32-NEXT:    [[TMP0:%.*]] = insertelement <2 x i16> poison, i16 [[E0:%.*]], i64 0
// RV32-NEXT:    [[TMP1:%.*]] = insertelement <2 x i16> [[TMP0]], i16 [[E1:%.*]], i64 1
...
// RV32-LABEL: @test_pjoin4_i16x4(
// RV32-NEXT:  entry:
// RV32-NEXT:    [[TMP0:%.*]] = insertelement <4 x i16> poison, i16 [[E0:%.*]], i64 0
// RV32-NEXT:    [[TMP1:%.*]] = insertelement <4 x i16> [[TMP0]], i16 [[E1:%.*]], i64 1
// RV32-NEXT:    [[TMP2:%.*]] = insertelement <4 x i16> [[TMP1]], i16 [[E2:%.*]], i64 2
// RV32-NEXT:    [[TMP3:%.*]] = insertelement <4 x i16> [[TMP2]], i16 [[E3:%.*]], i64 3
...
// RV32-LABEL: @test_pjoin2_i32x2(
// RV32-NEXT:  entry:
// RV32-NEXT:    [[TMP0:%.*]] = insertelement <2 x i32> poison, i32 [[E0:%.*]], i64 0
// RV32-NEXT:    [[TMP1:%.*]] = insertelement <2 x i32> [[TMP0]], i32 [[E1:%.*]], i64 1
